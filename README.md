...
| ssl_cert_valid_seconds                | The remaining validity time in seconds.                                                                      | serial_no, issuer_cn, cn, dnsnames, ips, emails, ou                         | tcp, https |
...
| ssl_file_valid_seconds            | The remaining validity time in seconds.                                                                          | file, serial_no, issuer_cn, cn, dnsnames, ips, emails, ou                   | file       |
...
| ssl_kubernetes_cert_valid_seconds | The remaining validity time in seconds.                                                                          | namespace, secret, key, serial_no, issuer_cn, cn, dnsnames, ips, emails, ou | kubernetes |
...
| ssl_kubeconfig_cert_valid_seconds | The remaining validity time in seconds.                                                                          | kubeconfig, name, type, serial_no, issuer_cn, cn, dnsnames, ips, emails, ou | kubeconfig |
...
| ssl_verified_cert_valid_seconds   | The remaining validity time in seconds.                                                                          | chain_no, serial_no, issuer_cn, cn, dnsnames, ips, emails, ou               | tcp, https |
